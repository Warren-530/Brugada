...
from brugada.app_ui_helpers import render_metric_with_info
...
from brugada.record_store import (
    get_record_counts,
    get_record_payload,
    list_records,
    save_batch_results,
...
def render_records_tab():
    ...
    status_display = st.radio("Status Filter", ["Active", "Archived", "Deleted", "All"], horizontal=True, key="records_status_filter")
    status_map = {
        "Active": "active",
        "Archived": "archived",
        "Deleted": "deleted",
